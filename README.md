...
|---|---|---|---|
| <a href="https://github.com/dlfjsld1"><img src="https://github.com/dlfjsld1.png?size=112" width="56" height="56" alt="이태경 GitHub 프로필"></a><br>**이태경**<br>[@dlfjsld1](https://github.com/dlfjsld1) | **Team Lead**<br>Agent · Backend | 제품 기획, 시스템·백엔드 아키텍처, 공식 공고 수집, 문서 분석·OCR, 이전 공고 비교, 근거 검증, 정책 API와 LangGraph 통합 | 노드 상태와 분기, 실행 로그, 실패·검토 경로를 설계하고 Field Registry·Human Review 결과를 전체 Graph에 연결했습니다. |
| <a href="https://github.com/C-JJI"><img src="https://github.com/C-JJI.png?size=112" width="56" height="56" alt="최지혜 GitHub 프로필"></a><br>**최지혜**<br>[@C-JJI](https://github.com/C-JJI) | **Citizen PWA**<br>Local Matching · UX | 개인정보 중심 온보딩, 동적 로컬 프로필과 IndexedDB, 재귀 EligibilityRule matcher, `YES / NO / UNKNOWN / STALE` 판정, 추가 질문과 정책 피드 | Field Registry Agent 로직을 구현해 canonical field 재사용, 신규 필드 제안, 모호한 후보와 중복 제안 방지 흐름을 완성했습니다. |
| <a href="https://github.com/kimjun-dev"><img src="https://github.com/kimjun-dev.png?size=112" width="56" height="56" alt="김준 GitHub 프로필"></a><br>**김준**<br>[@kimjun-dev](https://github.com/kimjun-dev) | **Admin · Integration**<br>AWS Infrastructure | 관리자 검토·승인 화면, Agent 실행 로그와 근거 표시, 프런트·백엔드 통합, AWS 인프라·배포와 운영 환경 연결 | Human-in-the-loop Agent 로직을 구현해 검토 판단, 미해결 필드, AgentRun과 Publish 전 검토 객체 생성 흐름을 완성했습니다. |
